package com.spring.ai4life.constants;
...
public class MessageUnit {
    ...
    public static final String NO_DATA = "15";
    public static final String MESSAGE_VI_NO_DATA = "Không có dữ liệu...";
    public static final String MESSAGE_EN_NO_DATA = "No data...";
